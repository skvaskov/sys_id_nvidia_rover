...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'laser_proc' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/Wokspace/umfordavmodelcar_ws/ros_ws/urg_node_ws/install/${idir}'.  Ask the maintainer 'Chad Rockey <chadrockey@willowgarage.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/nvidia/Wokspace/umfordavmodelcar_ws/ros_ws/urg_node_ws/install/lib;/home/nvidia/Wokspace/umfordavmodelcar_ws/ros_ws/point_grey_ws/devel/lib;/opt/ros/kinetic/lib)
