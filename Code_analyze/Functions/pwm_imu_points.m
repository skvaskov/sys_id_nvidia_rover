function [P_out,vx_out,ax_out,vy_out,w_out,P_stout]= pwm_imu_points(data,tnums,threshold,pl,P,vx,ax,vy,w,Pst)
...
axadd=[axadd;data(tnums(i)).interp.imu.longaccel_smooth(idxs:idxe)];
